...
__global__ void conv_forward_kernel(float *__restrict__ output,
                                    ...
                                    const int Height_out, const int Width_out)
{
    ...
    #define in_4d(i3, i2, i1, i0) input[((size_t)(i3)*(Channel*Height*Width) + \
                                         ...
                                         (i1)*(Width) + \
                                         (i0))]
    #define mask_4d(i3, i2, i1, i0) mask[( (size_t)(i3)*(Channel*K*K) + (i2)*(K*K) + (i1)*K + (i0))]
                                             ...
                                             const int K)
{
    ...
    conv_forward_kernel<<<num_blocks, threads_per_block>>>(device_output,
                                                           device_input,
                                                           device_mask,
